...
Приоритеты компании PropDevelopment:

1. Повысить уровень удовлетворённости клиентов (жалобы на ошибки в личном кабинете, возможно, смешивание данных клиентов).

2. Не могут расширять направление обработки данных (проблемы с управлением и хранением потоков данных блокируют новые сервисы на базе BI, ML, AI).

3. Отреагировать на инциденты и рыночные изменения (опасения по поводу утечек данных, как у конкурента).

4. Проверить соответствие требованиям законодательства (развитие IT-ландшафта, новые интеграции, требования по защите персональных данных).

Исходя из этого, в проверочный лист нужно включить вопросы, которые помогут выявить:

- Проблемы управления доступом, которые могут привести к смешиванию данных клиентов (например, недостаточная изоляция сессий, ошибки в контроле доступа на уровне приложения).

- Проблемы управления данными (Data Governance), которые мешают использовать данные для новых сервисов.

- Меры защиты от утечек данных (шифрование, контроль доступа, мониторинг).

- Соответствие законодательству (в частности, 152-ФЗ о персональных данных).
...
| 15                                                    | Реализована ли изоляция сессий и данных на уровне кода в приложении и client-crm-app, чтобы одна сессия не могла получить данные другой     | нет    |             |
